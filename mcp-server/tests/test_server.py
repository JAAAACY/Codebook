...
def test_mcp_server_has_five_tools():
    """MCP Server 注册了 11 个 tool。"""
    from src.server import mcp

    tools = mcp._tool_manager._tools
    tool_names = set(tools.keys())
    expected = {"scan_repo", "read_chapter", "diagnose", "ask_about", "codegen", "term_correct", "memory_feedback", "codebook", "watch_repo", "stop_watch", "watch_status"}
